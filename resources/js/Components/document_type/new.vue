<script setup>
  ...
  const onSave = () => {
      ...
      axios.post("/api/add_documenttype",formData).then(function () {
              ...
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                    <a href='/documenttype_list'>Document Type List</a>  /  Add New Document Type
                  </li>
                ...
                <div class="card">
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Name" v-model="form.type_name">
                      </div>
