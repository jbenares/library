                  ...
                  <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Business Unit</label>
                                <select class="form-select" v-model="form.unit_id" disabled >
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Department</label>
                                <select class="form-select" v-model="form.department_id" disabled>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Document Type</label>
                                <select class="form-select" v-model="form.type_id" disabled>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Subject</label>
                            <input type="text" class="form-control" v-model="form.subject" disabled/>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" v-model="form.document_date" disabled/>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="form.person_name" disabled/>
                          </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="form.keywords" disabled/>
                          </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="datalist"  class="form-control" id='location' list="locationlist" v-model="form.location" disabled> 	
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Room</label>
                            <input type="datalist"  class="form-control" id='room' list="roomlist" v-model="form.room" disabled> 	
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Cabinet</label>
                            <input type="datalist"  class="form-control" id='cabinet' list="cabinetlist" v-model="form.cabinet" disabled> 	
                    ...
                    <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Rack</label>
                            <input type="datalist"  class="form-control" id='rack' list="racklist" v-model="form.rack" disabled> 	
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="datalist"  class="form-control" id='box' list="boxlist" v-model="form.box" disabled> 	
														<datalist id="boxlist">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="datalist"  class="form-control" id='folder' list="folderlist" v-model="form.folder" disabled> 	
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label>Remarks</label>
                            <textarea  class="form-control" row="5" v-model="form.remarks" disabled></textarea>
                          </div>
                        </div>
                    </div>
                    <div class="row">
