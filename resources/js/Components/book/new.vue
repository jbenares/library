              ...
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                    <a href='/'>Book List</a>  /  Add new Book
                  </li>
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="mt-2" v-if="imageUrl1 == ''">
                            <img :src="'/books/default.png'" class="rounded shadow-md border-white border " style="width:150px"/>
                        </div> 
                      ...
                      <button @click="onSave()" class="btn btn-primary mr-2 ">Add Book</button>
